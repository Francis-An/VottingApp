...
class _AuthScreen extends State<AuthScreen> {
  ...
  Future<void> pickImage(ImageSource source) async {
    ...
    final selectedImage = ImagePicker();
    var _image = await selectedImage.pickImage(
            source: source, maxHeight: 300);
    setState(() async {
      if (true) {
        
        _imagePicked = File(_image!.path);
                    ...
                    children: [
                      ...
                      TextButton(
                        ...
                        child: Text(
                          ...
                          style:
                              TextStyle(color: secondary_color, fontSize: 18.0),
                        ),
                      )
                    ],
                  ),
